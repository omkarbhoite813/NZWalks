...
namespace NZWalks.API.Data
{
    public class NZWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Seed Difficulties data into the database
            // Easy , Medium, Hard
            ...
            var regions = new List<Region>()
            {
                ...
                new Region
                {
                    ...
                    Name = "Wellington",
                    Code = "WGN",
                    RegionImageUrl = "https://images.pexels.com/photos/4350631/pexels-photo-4350631.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dr=1"
                },
                new Region
                {
            ...
            // Seed Regions data into the database
